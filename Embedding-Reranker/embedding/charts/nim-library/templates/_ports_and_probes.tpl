...
{{- if .Values.model -}}
{{ coalesce .Values.model.openaiPort .Values.model.httpPort }}
{{- else if .Values.nim -}}
{{ coalesce .Values.nim.openaiPort .Values.nim.httpPort }}
{{- end -}}
{{- end -}}
...
- containerPort: {{ .Values.model.httpPort }}
  name: http
{{- end }}
{{- if .Values.model.openaiPort }}
- containerPort: {{ .Values.model.openaiPort }}
  name: http-openai
{{- end }}
...
- containerPort: {{ .Values.nim.httpPort }}
  name: http
{{- end }}
{{- if .Values.nim.openaiPort }}
- containerPort: {{ .Values.nim.openaiPort }}
  name: http-openai
{{- end }}
...
"http"
{{- else if .Values.service.openaiPort -}}
"http-openai"
{{- end -}}
{{- end -}}
